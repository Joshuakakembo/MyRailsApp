        ...
        <ul className="nav">
            ...
            <Collapse in={this.state.generalPagesMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  ...
                  <Link
                    className={
                      this.isPathActive("/domain_visibility/DomainPage")
                        ? "nav-link active"
                        : "nav-link"
                    }
                    to="/domain_visibility/DomainPage"
                  >
                    <Trans>Domains</Trans>
                  </Link>
                </li>
          ...
          {/* <li className={ this.isPathActive('/basic-ui') ? 'nav-item active' : 'nav-item' }>
            <div className={ this.state.basicUiMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('basicUiMenuOpen') } data-toggle="collapse">
              <span className="menu-title"><Trans>Domain Visibility</Trans></span>
              <i className="menu-arrow"></i>
            ...
            <Collapse in={this.state.formElementsMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  ...
                  <Link
                    className={
                      this.isPathActive("/domain_register/DomainRegister")
                        ? "nav-link active"
                        : "nav-link"
                    }
                    to="/domain_register/DomainRegister"
                  >
            ...
            <Collapse in={this.state.iconsMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  ...
                  <Link
                    className={
                      this.isPathActive("/modify_domain/registrant")
                        ? "nav-link active"
                        : "nav-link"
                    }
                    to="/modify_domain/registrant"
                  >
                ...
                <li className="nav-item">
                  ...
                  <Link
                    className={
                      this.isPathActive("/modify_domain/admin")
                        ? "nav-link active"
                        : "nav-link"
                    }
                    to="/modify_domain/admin"
                  >
                    <Trans>Admin</Trans>
                  </Link>
                </li>
                <li className="nav-item">
                  ...
                  <Link
                    className={
                      this.isPathActive("/modify_domain/billing")
                        ? "nav-link active"
                        : "nav-link"
                    }
                    to="/modify_domain/billing"
                  >
                    <Trans>Billing</Trans>
                  </Link>
                </li>
                <li className="nav-item">
                  ...
                  <Link
                    className={
                      this.isPathActive("/modify_domain/tech")
                        ? "nav-link active"
                        : "nav-link"
                    }
                    to="/modify_domain/tech"
                  >
                    <Trans>Tech</Trans>
                  </Link>
                </li>
                <li className="nav-item">
                  ...
                  <Link
                    className={
                      this.isPathActive("/modify_domain/name_servers")
                        ? "nav-link active"
                        : "nav-link"
                    }
                    to="/modify_domain/name_servers"
                  >
